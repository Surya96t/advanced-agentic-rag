...
- ✅ **ALWAYS discuss changes first** - Explain what you plan to create/modify and get approval before making changes
- ✅ **Present options** when multiple approaches exist
- ✅ **Ask clarifying questions** before assuming implementation details
